...
if __name__ == "__main__":
    ...
    #mapping = None
    create_coco(path / "annotations/test", path / "textdet_imgs/test", Path("data-coco"), mapping
    )