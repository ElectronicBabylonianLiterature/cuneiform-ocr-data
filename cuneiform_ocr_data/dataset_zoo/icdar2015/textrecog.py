...
data_obtainer = dict(
    ...
    files=[
        dict(
            url="https://rrc.cvc.uab.es/downloads/" "ch4_training_word_images_gt.zip",
        ...
        dict(
            url="https://rrc.cvc.uab.es/downloads/" "Challenge4_Test_Task3_GT.txt",
...
data_converter = dict(
    ...
    splits=["train", "test"],
    data_root=data_root,
    gatherer=dict(type="mono_gather", train_ann="train.txt", test_ann="test.txt"),
